...
async function fixProfiles() {
    ...
    if (adminUser) {
        ...
        if (pErr)
            console.error("Error inserting admin profile:", pErr);
        else
            console.log("Admin profile fixed/created successfully.");
    }
    ...
    if (cashierUser) {
        ...
        if (pErr)
            console.error("Error inserting cashier profile:", pErr);
        else
            console.log("Cashier profile fixed/created successfully.");
    }
}
fixProfiles();
